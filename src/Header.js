...
import { Link, json, useLocation, useMatch } from "react-router-dom";
        ...
        >
          {navItems.map((item, index) => (
           ...
           <div className="iconDiv positioning">
                ...
                <div  className="dropDownposition" id="dropDownPosition">
            ...
            <div className="iconDiv positioning">
                ...
                <div  className="dropDownposition" id="dropDownPosition1">
